...
def which_model(which_model):
    if which_model == "resnet101":
        print("Model name: ResNet101Encoder")
        return ResNet101Encoder()
    elif which_model == "resnet152":
        print("Model name: ResNet152Encoder")
        return ResNet152Encoder()
    elif which_model == "resnet50":
        print("Model name: ResNet50Encoder")
        return ResNet50Encoder()
    elif which_model == "resnet34":
        print("Model name: ResNet34Encoder")
        return ResNet34Encoder()
    elif which_model == "resnet18":
        print("Model name: ResNet18Encoder")
        return ResNet18Encoder()
    else:
        print(
            f"User selected {which_model} model not found.\r\nPlease select one of the available models ('resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152') correctly."
        ) 
        exit()
...
class ResNet34Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        resnet = torchvision.models.resnet34(pretrained=True)  # pretrained ImageNet ResNet-34
...
class ResNet152Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        model = torchvision.models.resnet152(pretrained=True)  # pretrained ImageNet ResNet-152
