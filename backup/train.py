...
def main():
    ...
    global best_bleu4, epochs_since_improvement, checkpoint, start_epoch, fine_tune_encoder, data_name, word_map, recent_bleu4
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if is_best:
            filename = directory + 'checkpoints/BEST_checkpoint_' + data_name + '.pth.tar'
            save_checkpoint(filename, epoch, epochs_since_improvement, encoder, decoder, encoder_optimizer,
                        decoder_optimizer, recent_bleu4)

        filename = directory + 'checkpoints/checkpoint_' + data_name + '.pth.tar'
        save_checkpoint(filename, epoch, epochs_since_improvement, encoder, decoder, encoder_optimizer,
                    decoder_optimizer, recent_bleu4)
